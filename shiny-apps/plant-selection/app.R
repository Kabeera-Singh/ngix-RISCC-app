...
ui <- fluidPage(
  ...
  div(class = "main-container",
    div(class = "info-card",
      ...
      p("Select your state and desired site and plant characteristics below. Filter columns must match for plants to appear in results. Sorting columns re-order plants based on a match score without reducing the list, putting \"best match\" species first. This tool is still under construction. Resulting lists may not be fully correct."),
